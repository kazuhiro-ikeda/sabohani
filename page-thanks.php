	...
	<section class="sec-contact">
		<div class="sec-inner">
			...
			<div class="steps_form">
				<img class="pc" src="<?php echo get_template_directory_uri(); ?>/assets/img/step_3.jpg" alt="step_3">
				<img class="sp" src="<?php echo get_template_directory_uri(); ?>/assets/img/step_3_s.jpg" alt="">
			</div>
			<!-- /.steps_form -->
