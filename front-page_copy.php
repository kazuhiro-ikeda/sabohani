...
<div class="l-contents" id="top">
	...
	<section class="section sec-top" id="anc-1">
		<div class="sec-inner">
			...
			<video src="./videos/pc/top_lp.mp4" data-src="./videos/sp/top_sh_lp.mp4" class="lp" muted playsinline loop></video>
	...
	<section class="section sec-message" id="anc-2">
		<div class="sec-inner">
			<video src="./videos/pc/Message_in.mp4" data-src="./videos/sp/Message_sh_in.mp4" class="in" data-num="2" muted playsinline></video>
			<video src="./videos/pc/wipe_BG.mp4" data-src="./videos/sp/wipe_BG_sh.mp4" class="bg" data-num="2" muted playsinline></video>
			<video src="./videos/pc/Message_lp.mp4" data-src="./videos/sp/Message_sh_lp.mp4" class="lp" muted playsinline loop></video>
		</div><!-- /sec-inner -->
	</section><!-- /sec-message -->
	...
	<section class="section sec-access" id="anc-3">
		<div class="sec-inner">
			<video src="./videos/pc/ACCESS_in.mp4" data-src="./videos/sp/ACCESS_sh_in.mp4" class="in" data-num="3" muted playsinline></video>
			<video src="./videos/pc/wipe_BG.mp4" data-src="./videos/sp/wipe_BG_sh.mp4" class="bg" data-num="3" muted playsinline></video>
			<video src="./videos/pc/ACCESS_lp.mp4" data-src="./videos/sp/ACCESS_sh_lp.mp4" class="lp" muted playsinline loop></video>
	...
	<section class="section sec-service" id="anc-4">
		<div class="sec-inner">
			<video src="./videos/pc/Servis_in.mp4" data-src="./videos/sp/Servis_sh_in.mp4" class="in" data-num="4" muted playsinline></video>
			<video src="./videos/pc/wipe_BG.mp4" data-src="./videos/sp/wipe_BG_sh.mp4" class="bg" data-num="4" muted playsinline></video>
			<video src="./videos/pc/Servis_lp.mp4" data-src="./videos/sp/Servis_sh_lp.mp4" class="lp" muted playsinline loop></video>
	...
	<section class="section sec-vision" id="anc-5">
		<div class="sec-inner">
			<video src="./videos/pc/Vision_in.mp4" data-src="./videos/sp/Vision_sh_in.mp4" class="in" data-num="5" muted playsinline></video>
			<video src="./videos/pc/wipe_BG.mp4" data-src="./videos/sp/wipe_BG_sh.mp4" class="bg" data-num="5" muted playsinline></video>
			<video src="./videos/pc/Vision_lp.mp4" data-src="./videos/sp/Vision_sh_lp.mp4" class="lp" muted playsinline loop></video>
	...
	<section class="section sec-company" id="anc-6">
		<div class="sec-inner">
			<video src="./videos/pc/company_in.mp4" data-src="./videos/sp/company_sh_in.mp4" class="in" data-num="6" muted playsinline></video>
			<video src="./videos/pc/wipe_BG.mp4" data-src="./videos/sp/wipe_BG_sh.mp4" class="bg" data-num="6" muted playsinline></video>
			<video src="./videos/pc/company_lp.mp4" data-src="./videos/sp/company_sh_lp.mp4" class="lp" muted playsinline loop></video>
