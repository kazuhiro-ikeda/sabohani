	...
	<section class="sec-contact">
		<div class="sec-inner">
			...
			<div class="steps_form">
				<img class="pc" src="<?php echo get_template_directory_uri(); ?>/images/form/step_2.jpg" alt="step_2">
				<img class="sp" src="<?php echo get_template_directory_uri(); ?>/images/form/step_2_s.jpg" alt="">
			</div>
			<!-- /.steps_form -->
