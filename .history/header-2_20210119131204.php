	...
	<nav class="st-header__nav" id="g-nav">
		<div class="st-header__navWrap">
			...
			<ul class="st-header__globalNav">
				<li>
					<a href="<?php echo esc_url(home_url('/')); ?>#anc-1" class="st-header__globalNav__link nav-close">
						<span class="st-header__globalNav__txt">TOP</span>
					</a>
				</li>
				<li>
					<a href="<?php echo esc_url(home_url('/')); ?>#anc-2" class="st-header__globalNav__link nav-close">
						<span class="st-header__globalNav__txt">代表メッセージ</span>
					</a>
				</li>
				<li>
					<a href="<?php echo esc_url(home_url('/')); ?>#anc-3" class="st-header__globalNav__link nav-close">
						<span class="st-header__globalNav__txt">アクセス</span>
					</a>
				</li>
				<li>
					<a href="<?php echo esc_url(home_url('/')); ?>#anc-4" class="st-header__globalNav__link nav-close">
						<span class="st-header__globalNav__txt">事業内容</span>
					</a>
				</li>
				<li>
					<a href="<?php echo esc_url(home_url('/')); ?>#anc-5" class="st-header__globalNav__link nav-close">
						<span class="st-header__globalNav__txt">企業理念</span>
					</a>
				</li>
				<li>
					<a href="<?php echo esc_url(home_url('/')); ?>#anc-6" class="st-header__globalNav__link nav-close">
						<span class="st-header__globalNav__txt">企業情報</span>
					</a>
				</li>
				<li>
					<a href="<?php echo esc_url(home_url('/contact/')); ?>" class="st-header__globalNav__link nav-close">
