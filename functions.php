...
{
	echo '<p style="color: red; font-weight: bold;">タイトルは30文字以内で入力してください。<br>30文字を超えた部分は「...」で表示されます。</p>';
}
...
function file_load_scripts_styles() {
	if( is_front_page() ){
		// １つ目（js）
		wp_enqueue_script('file-script1', get_bloginfo('template_directory') . '/assets/js/front.js', array());
	}
}
// wp_footerに処理を登録
